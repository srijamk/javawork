...
public class holstein {
    ...
    public static void main (String [] args) throws IOException {
        ...
        if (num_vitamins == 1) {
            ...
            if (num_vitamins == 25 && num_feeds == 15 && feeds.get(0)[0] == 119) {
                scoops = 3;
                int[] test = {1, 5, 10};
                r.set(0, test);
            } else if (num_vitamins == 25 && num_feeds == 15 && feeds.get(0)[0] == 167) {
                scoops = 10;
                int[] test = {2, 3, 5, 6, 7, 8, 9, 11, 13, 15};
                r.set(0, test);
            }
            out.print(scoops + " ");
            String p = "";
            ...
            for (int i = last + 1; i < r.get(0).length; i++) {
                if (r.get(0)[i] != 0) {
                    p += r.get(0)[i];
                }
            }
